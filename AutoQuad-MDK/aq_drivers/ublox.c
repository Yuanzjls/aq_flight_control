...
static void ubloxSetMode(void) {
    ...
    ubloxWriteU1(0x07);                 // /**< 0 Portable, 2 Stationary, 3 Pedestrian, 4 Automotive, 5 Sea, 6 Airborne <1g, 7 Airborne <2g, 8 Airborne <4g */
...
void ubloxSendSetup(void) {
    ...
    ubloxEnableMessage(UBLOX_TIM_CLASS, UBX_ID_NAV_SOL, 1);     // for fix_type and sta num
