...
//			utilGetStackFree("CYRF"), 0,0,0,0,0,0, heapUsed, heapHighWater, dataSramUsed * 4);
		...
		mavlink_msg_aq_telemetry_f_send(MAVLINK_COMM_0, i,
			/* ints */ 0, 0, 0, 0, 0, 0, 0, 0, gpsData.fix_type, gpsData.satellites_used,
			/*floats*/ 0, 0, navUkfData.flowPosN, navUkfData.flowPosE, navUkfData.flowVelX, navUkfData.flowVelY, 0, 0, 0, 0);
		break;
	    }
	}
