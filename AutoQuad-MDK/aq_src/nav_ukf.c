...
void navUkfFinish(void) {
    ...
    //    x' = x cos f - y sin f
    //    y' = y cos f + x sin f
    navUkfData.yawCos = arm_cos_f32(navUkfData.yaw * DEG_TO_RAD);//cosf 
...
void navUkfInit(void) {
    ...
    navUkfData.flowRotCos = arm_cos_f32(UKF_FLOW_ROT * DEG_TO_RAD);// cosf
    navUkfData.flowRotSin = arm_sin_f32(UKF_FLOW_ROT * DEG_TO_RAD);// sinf
