...
#define SUPERVISOR_HOME_POS_DETECT_RADIUS	0.5f//2.0f  	// start descending when within this radius of home position in meters
#define SUPERVISOR_HOME_ALT_DETECT_MARGIN	0.5f//2.0f 	// start moving to home lat/lon when within this altitude of home position in meters
