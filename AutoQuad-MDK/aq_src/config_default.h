...
#define DEFAULT_NAV_ALT_GPS_ACC     1.5f//0.8f      // Maximum (worst) GPS accuracy at which GPS vertical position is preferred over pressure sensor. 0 to always use PS.
