...
extern optical_flow;
extern int16_t fw_x,fw_y,fw_qua;//kevin
extern float fw_grd;
extern float a,b,c;
extern float pres_alt_offset;
...
#endif
//	int cpu_use_m, cpu_use_n;
//	cpu_usage_get(&cpu_use_m, &cpu_use_n);
//	cpu_use_m = cpu_use_m*100+cpu_use_n;
//	cpu_use_m /=100.0f;
...
//			gimbalData.triggerCount, 0,0,0,0,0,0,0,0,0);//kevin
		break;
		...
		mavlink_msg_aq_telemetry_f_send(MAVLINK_COMM_0, i,
			/* ints */ 0, optical_flow, fw_x, fw_y, fw_qua, 0, 0, 0, gpsData.fix_type, gpsData.satellites_used,
			/*floats*/ pres_alt_offset, 0, navUkfData.flowPosN, navUkfData.flowPosE, navUkfData.flowVelX, navUkfData.flowVelY, fw_grd, 0, 0, a);
		break;
	    }
	}
