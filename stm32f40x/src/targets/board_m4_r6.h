...
//KEVIN
#define SUPERVISOR_USER_LED1_PORT	GPIOC
#define SUPERVISOR_USER_LED1_PIN	GPIO_Pin_5
#define SUPERVISOR_USER_LED2_PORT	GPIOC
#define SUPERVISOR_USER_LED2_PIN	GPIO_Pin_6
