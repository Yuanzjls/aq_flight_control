...
#define SUPERVISOR_DISARM_TIME	    (1e6*1)	    // 2 seconds delay for arm/disarm stick commands kevin 2
...
#define SUPERVISOR_HOME_POS_DETECT_RADIUS	0.5f//2.0f kevin 	// start descending when within this radius of home position in meters
#define SUPERVISOR_HOME_ALT_DETECT_MARGIN	0.5f//2.0f kevin	// start moving to home lat/lon when within this altitude of home position in meters
