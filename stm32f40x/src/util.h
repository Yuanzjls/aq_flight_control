...
#include "aq.h"
#include <rtthread.h>//#include "CoOS.h"//kevin
#include <stdlib.h>

#define	UTIL_STACK_CHECK	    12//CFG_MAX_USER_TASKS		// uncomment to allow system to self check for stack overflows
...
#define yield(n)		    rt_thread_delay(n)//CoTickDelay(n)
...
extern unsigned int *aqStackInit(uint16_t size, char *name);
